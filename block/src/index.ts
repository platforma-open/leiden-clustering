...
export type LeidenClusteringBlockContract = BlockContract;
export type LeidenClusteringBlockOutputs  = BlockOutputs;
export type LeidenClusteringBlockData     = BlockData;
export const LeidenClusteringBlockPointer = BlockPointer;
